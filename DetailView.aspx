...
<body>
    ...
    <div>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="Recipt_ID" DataSourceID="SqlDataSource1" Height="50px" Width="603px" CssClass="gridview">
            <Fields>
